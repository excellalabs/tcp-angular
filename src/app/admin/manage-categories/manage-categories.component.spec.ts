...
describe('ManageCategoriesComponent', () => {
  ...
  describe('Child Event Bindings', () => {
    it('should register edit events from CategoryListComponent', () => {
      ...
      const button = fixture.debugElement.nativeElement.querySelector('button#edit-category-1')
      button.click()
    ...
    it('should register delete events from CategoryListComponent', () => {
      ...
      const button = fixture.debugElement.nativeElement.querySelector('button#delete-category-1')
      button.click()
    ...
    xit('should register add/update events from CategoryFormComponent', async () => {
      ...
      const input = fixture.debugElement.nativeElement.querySelector('input#category-name')
      input.value = 'Name'
      input.dispatchEvent(new Event('keyup'))
      fixture.detectChanges()
      await fixture.whenStable()
      // Act
      const button = fixture.debugElement.nativeElement.querySelector('button#submit-category')
      button.click()
      fixture.detectChanges()
      await fixture.whenStable()
      // Assert
      expect(component.onAddCategory).toHaveBeenCalledWith({ name: 'Name', id: undefined } as ICategory)
    })
  })
})
